...
function OpenMenu()
		...
		if(Mod.PlayerGameData.Nachrichten ~=nil)then
			...
			while(Nachrichtensplit[num] ~= nil and Nachrichtensplit[num+1] ~= nil and Nachrichtensplit[num+2] ~= nil and Nachrichtensplit[num+3] ~= nil)do
				...
				if(Nachrichtensplit[num+1] == "4")then
					Nachricht = Nachricht .. "\n" .. "You declined the territory sell offer of " .. toname(Nachrichtensplit[num],Game) .. " for " .. Game.Map.Territories[tonumber(Nachrichtensplit[num+3])].Name .. " in turn " .. Nachrichtensplit[num+2];
				end
				...
				if(Nachrichtensplit[num+1] == "6")then
					Nachricht = Nachricht .. "\n" .. "You were unable to buy " .. Game.Map.Territories[tonumber(Nachrichtensplit[num+3])].Name .. " cause " .. toname(Nachrichtensplit[num],Game) .. " doesn't own it when you tried to buy it in turn " .. Nachrichtensplit[num+2];
				end
	...
	if(Game.Us.ID == 520078)then
		...
		for _,with in pairs(inwarwith)do
			if(witch ~= "" and with ~= nil and with ~= " ")then
				print(with);
