...
function ShowUI()
	...
	texthorz = UI.CreateHorizontalLayoutGroup(rootParentobj);
	inputGiftCardRequirePeace = UI.CreateCheckBox(texthorz).SetText('Bomb Cards require peace').SetIsChecked(GiftCardRequirePeaceinit);
	texthorz = UI.CreateHorizontalLayoutGroup(rootParentobj);
	inputGiftCardRequireAlly = UI.CreateCheckBox(texthorz).SetText('Bomb Cards require ally').SetIsChecked(GiftCardRequireAllyinit);
	texthorz = UI.CreateHorizontalLayoutGroup(rootParentobj);
	UI.CreateLabel(texthorz).SetText(' ');
	texthorz = UI.CreateHorizontalLayoutGroup(rootParentobj);
